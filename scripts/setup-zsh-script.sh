#!/bin/bash
# scripts/setup-zsh.sh - Dream Container Setup for Zsh Users
# 💭 Run this script to make your development dreams come true!
#
# Usage:
#   ./scripts/setup-zsh.sh           # Smart caching (recommended)
#   ./scripts/setup-zsh.sh --fresh   # Force clean build
#   ./scripts/setup-zsh.sh --no-cache # Same as --fresh
...
echo -e "${BLUE}${DREAM} DREAM CONTAINER Setup (Zsh)${NC}"
echo -e "${BLUE}==============================${NC}"
echo -e "${PURPLE}Making your development dreams come true...${NC}"
echo -e "${CYAN}${SHELL_ICON} Optimized for Zsh users${NC}"
echo ""
...
if $BUILD_CMD; then
    ...
    echo -e "${YELLOW}💡 Tip: Try running with --fresh flag for a clean build: ./scripts/setup-zsh.sh --fresh${NC}"
    exit 1
fi
...
# ==========================================
# 🎯 ZSH-SPECIFIC CONVENIENCE OPTIONS
# ==========================================
...
print_severance "This will streamline your Zsh development workflow and eliminate future"
...
# ==========================================
# 🎉 ZSH-SPECIFIC COMPLETION & NEXT STEPS
# ==========================================

echo ""
echo -e "${GREEN}${FIRE}${FIRE}${FIRE} DREAMS ACHIEVED! ${FIRE}${FIRE}${FIRE}${NC}"
echo -e "${GREEN}Your Dream Container environment is ready for Zsh!${NC}"
echo ""
...
echo -e "  • ${YELLOW}Rebuild (cached):${NC} ./scripts/setup-zsh.sh"
echo -e "  • ${YELLOW}Rebuild (fresh):${NC} ./scripts/setup-zsh.sh --fresh"
echo -e "  • ${YELLOW}Health check:${NC} docker-compose ps"
echo ""

# Conditional next steps based on what was configured
echo -e "${CYAN}💡 Getting Started with Zsh:${NC}"
...
if [ "$github_authenticated" = false ]; then
    ...
    echo -e "   ${CYAN}💡 Zsh tip: Add to ~/.zshrc for persistent tokens:${NC}"
    echo -e "   ${YELLOW}echo 'export GITHUB_TOKEN=\"your_token\"' >> ~/.zshrc${NC}"
...
echo -e "${PURPLE}${SPARKLES} Your Zsh development dreams are now reality! ${SPARKLES}${NC}"
...
print_severance "Your Zsh environment has been optimized for maximum productivity."
echo -e "${WHITE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
